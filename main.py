...
async def generate_workout(update: Update, context: CallbackContext) -> int:
    ...
    Пример:
    🏋️ Тренировка: [Название тренировки]

    📍 Место: {location}
    ⏱ Длительность: {duration} минут
    🎯 Фокус: [на какие группы мышц]

    🔥 Разминка ([время] минут):
    - [Упражнение] - [время/повторы]
    - [Упражнение] - [время/повторы]
    - [Упражнение] - [время/повторы]

    💪 Основная часть:
    - [Упражнение] - [подходы]x[повторы] (краткое уточнение)
    - [Упражнение] - [подходы]x[повторы] (краткое уточнение)
    - [Упражнение] - [подходы]x[повторы] (краткое уточнение)
    - [Упражнение] - [подходы]x[повторы] (краткое уточнение)

    🧘 Заминка ([время] минут):
    - [Растяжка] - [время] (подробное описание)
    - [Растяжка] - [время] (подробное описание)
    - [Растяжка] - [время] (подробное описание)
...
29. Генерация тренировок:
    ⚠️ Общая длина ответа НЕ ДОЛЖНА превышать 1200 символов.
    ...
    💪 Основная часть:
    - [Упражнение] - [подходы]x[повторы] (краткое уточнение техники, если необходимо)
    - [Упражнение] - [подходы]x[повторы] (краткое уточнение техники, если необходимо)
    - [Упражнение] - [подходы]x[повторы] (краткое уточнение техники, если необходимо)
    - [Упражнение] - [подходы]x[повторы] (краткое уточнение техники, если необходимо)

    🧘 Заминка ([время] минут):
    - [Растяжка] - [время] (подробное описание выполнения)
    - [Растяжка] - [время] (подробное описание выполнения)
    - [Растяжка] - [время] (подробное описание выполнения)
    ...
    СТРОГИЕ ПРАВИЛА:
    1. Название тренировки должно отражать ее цель и место проведения
    2. Разминка должна содержать 3-4 упражнения с указанием времени/повторов
    3. Основная часть - 4-5 упражнений с подходами и повторениями в формате "3x12"
    4. В основной части допускается краткое уточнение техники в скобках (не более 5 слов)
    5. Заминка должна содержать 3-4 упражнения на растяжку с подробным описанием выполнения
    6. Рекомендации - строго 2 пункта, краткие и по существу
    7. Никаких лишних комментариев, только строго по формату
    8. Для разминки и заминки указывать общее время в скобках
    9. В основной части не указывать время, только подходы и повторения
    10. Никаких звездочек, смайликов (кроме указанных в начале разделов) и лишних символов

    Пример ПРАВИЛЬНОГО ответа:
    🏋️ Тренировка: Здоровые Ноги на Площадке

    📍 Место: Спортплощадка
    ⏱ Длительность: 30 минут
    🎯 Фокус: Ноги и общая физическая подготовка

    🔥 Разминка (5 минут):
    - Бег на месте - 1 минута
    - Прыжки "Джеки" - 2 подхода по 20 повторений
    - Махи ногами - по 10 повторений на каждую ногу
    - Круговые движения бедрами - по 10 повторений

    💪 Основная часть:
    - Приседания с прыжком - 3x12
    - Выпады на месте - 3x10 (каждая нога)
    - Подъемы на скамейку - 3x15 (каждая нога)
    - Отжимания на брусьях - 3x8
    - Подтягивания на турнике (классический хват) - 3x8

    🧘 Заминка (5 минут):
    - Растяжка квадрицепсов (захват стопы сзади) - 30 секунд на каждую ногу
    - Растяжка трицепсов (завести руку за голову) - 30 секунд на каждую руку
    - Наклон вперед к ногам стоя - 30 секунд
