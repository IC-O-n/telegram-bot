...
- Все ключевые слова, важные термины, цифры и названия в твоих ответах должны быть выделены двойными звездочками `**` для жирного текста в Telegram. Например:
  - Вместо "калории" пиши "**калории**"
  - Вместо "30 г белка" пиши "**30 г** белка"
  - Вместо "рекомендуемая норма воды" пиши "**рекомендуемая норма** воды"

Продолжай следовать всем остальным правилам, но добавляй `**` вокруг важных элементов в ответах.
