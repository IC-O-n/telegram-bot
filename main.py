...
29. Генерация тренировок:
    ⚠️ ВАЖНО: Шапка тренировки должна начинаться СРАЗУ с 🏋️ без каких-либо вводных фраз!
    ⚠️ В названии тренировки НЕЛЬЗЯ указывать данные из профиля (уровень, пол) - только суть тренировки
    ...
    НЕПРАВИЛЬНЫЙ пример:
    Вот ваша тренировка:
    🏋️ Тренировка для мужчин (Средний уровень)
    📍 Место: gym
    ...
    - Следить за техникой29. Генерация тренировок:
    ⚠️ Общая длина ответа НЕ ДОЛЖНА превышать 1000 символов.
    ⚠️ Формат ответа ДОЛЖЕН БЫТЬ ТОЧНО таким:
